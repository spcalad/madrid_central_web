...
from app.controllers.classificators_controller import index_classificators, create_classificators, delete_classificators
...
app_blueprints.add_url_rule('/measurements/generate_map', view_func=generate_air_stations_map, methods=['GET'])
app_blueprints.add_url_rule('/measurements/generate_air_map', view_func=generate_air_map, methods=['GET'])
...
app_blueprints.add_url_rule('/classificators/create', view_func=create_classificators, methods=['GET'])
app_blueprints.add_url_rule('/classificators/delete', view_func=delete_classificators, methods=['POST'])
